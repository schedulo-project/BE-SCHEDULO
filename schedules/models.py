...
class Tag(models.Model):
    ...
    user = models.ForeignKey(User, null=True, on_delete=models.CASCADE, related_name="tag")
...
class Schedule(models.Model):
    ...
    tag = models.ForeignKey(Tag, null=True, on_delete=models.CASCADE, related_name="tag")

class TimeTable(models.Model):
    subject = models.CharField(null=True, max_length=30)
    user = models.ForeignKey(User, null=True, on_delete=models.CASCADE, related_name="time_table")
    DAY_CHOICES = [
        ('mon', 'mon'),
        ('tue', 'tue'),
        ('wed', 'wed'),
